...
The linear fit follows the trend of the relationship. Residuals has a clear patterns and not tend to cluster towards the middle so it's not ideal, same as the prediction.
...
The fit is similar as the linear fit, the only difference is a small turnover at the start and end.
...
The fit and residual plots looks similar. The prediction value are close too. It's not good enough as the residual is not ideal.
