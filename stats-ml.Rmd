...
The loess model has an increase when the distance is 0.1 from the start point.
...
The random forest model is similar with the linear model, but it is not as smooth as the linear model.
...
This is very similar with the first linear model. 
